...
(function(global) {
    ...
    function initLocalStorage() {
        if (localStorage.getItem(STORAGE_KEYS.videos)) return;
        const sampleVideos = [
            {
                id: 1,
                title: '졸업작품: 어느 봄날의 기억',
                director: '김영화',
                directorId: 1,
                year: 2024,
                genre: '드라마',
                ...
                description: '잊고 싶었던 과거와 마주하게 된 한 청년의 이야기',
        ...
        if (!localStorage.getItem(STORAGE_KEYS.users)) {
            const defaultUsers = [{ id: 1, studentId: '20240001', name: '김영화', password: 'demo123' }];
